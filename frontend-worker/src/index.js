    ...
    <script>
        ...
        function renderListing(data, append) {
            ...
            files = files.filter(function(f){
                ...
                return !n.startsWith('__') && base !== '.DS_Store';
            });
